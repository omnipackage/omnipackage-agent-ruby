...
require 'agent/build/deb/debian_folder'
...
module Agent
  module Build
    module Deb
      class Package < ::Agent::Build::BasePackage
        def artefacts
        ...
        def setup # rubocop: disable Metrics/MethodLength, Metrics/AbcSize
          ...
          debian_folder = ::Agent::Build::Deb::DebianFolder.new(::Agent::Utils::Path.mkpath(source_path, debian_folder_template_path))
