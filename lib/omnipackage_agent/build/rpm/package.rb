    ...
    module Rpm
      class Package < ::OmnipackageAgent::Build::BasePackage
        ...
        def setup # rubocop: disable Metrics/MethodLength, Metrics/AbcSize
          ...
          rpmbuild_path = ::OmnipackageAgent::Utils::Path.mkpath(::OmnipackageAgent.build_dir, rpmbuild_folder_name)
          ...
          specfile.save(::OmnipackageAgent::Utils::Path.mkpath(::OmnipackageAgent.build_dir, rpmbuild_folder_name, specfile_name), template_params)
